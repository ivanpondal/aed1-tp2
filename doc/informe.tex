...
\end{problema*}
	...
	\begin{problema*}{agregarImagen}{g:Galeria, i: Imagen}
    \modifica{g}
    \asegura { i \in imagenes(g)    \rightarrow mismos(imagenes(g), imagenes(pre(g)))}
		\asegura { i \notin imagenes(g) \rightarrow mismos(imagenes(g), imagenes(pre(g)) ++\ i )}
	\end{problema*}
...
\begin{itemize}
	...
	\item \auxil{todosLosVotos(g: Galeria) : [\ent]}{
	  [votos(i) | i \leftarrow imagenes(g)]
	}
