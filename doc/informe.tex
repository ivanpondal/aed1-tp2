...
\begin{ejercicio}
	...
	\begin{problema}{posicionesMasOscuras}{i:Imagen}{res:[(\ent, \ent)]}
		\asegura{res == [(x,y)|$ $(x \leftarrow [0..ancho(i)),y \leftarrow [0..alto(i))),
		\newline cantColorPxl(color(i, x, y)) == cantColorPixelMasOscuro(i)] }
	\end{problema}
...
\begin{itemize}
	...
	\item \auxil{cantColorPixelMasOscuro(i: Imagen) : \ent}{
	  min[z | z \leftarrow listaCantColores(i)]
	}
	  
	\item \auxil{listaCantColores(i: Imagen) : \TLista{\ent}}{
	  [r$ $|$ $(x \leftarrow ancho(i), y \leftarrow alto(i)), r==cantColorPxl(color(i, x, y))]
	}
