...
\begin{ejercicio}
	...
	\begin{problema*}{eliminarMasVotada}{g: Galeria}
		...
		\modifica{g}
		\asegura{ mismos(imagenes(pre(g)), imagenes(g) ++\  imagenMasVotada(g))}
	\end{problema*}
...
\begin{itemize}
	...
	\item \auxil{imagenMasVotada(g: Galeria) : Imagen} { \newline
	  [i | i \leftarrow imagenes(g), votos(i) == max(todosLosVotos(g)) ] _0
	}
	
	\item \auxil{todosLosVotos(g: Galeria) : Imagen}{
